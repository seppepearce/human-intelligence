Keywords: #democracy #quality-over-quantity #manifesto #truth-seeking

Human Intelligence should push people to do the right thing by nature of itself: design language, high standards, recurring foundational principles. It should be almost impossible to act badly, not because you physically cant, but because you wouldn't want to. 

We will tackle this using behavioural theory

- Cultivating a thriving early adopter community might set its course in the right general direction.
...
- Not showing only viral trees, but showing credible and relevant ones more often.

- Definitely definitively NO infinite scrolling.

- Validation / encouragement that make you think twice about what you're about to put on the internet.

- We will never deny you access to any info, but you might lose your rights to contribute if on persisted bad behaviour.

- Shitposts could be flagged as such (warnings for use of NSFW language, etc).

In summary: push people to create and explore freely, but also to be humble and to take everything with a grain of salt. Always look for the truth but be mindful of settling on it.
